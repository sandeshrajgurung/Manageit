    ...
    <div class="flex">
        ...
        <div class="w-full h-auto p-3  overflow-y-auto  bg-gray-100">
                ...
                <div>
                    <div class="block rounded-lg shadow-lg bg-white">
                        <div class="overflow-hidden rounded-t-lg h-20" style="background-color: #9d789b;">
                            <p class="text-white mt-3 text-2xl">Employees</p>
                        </div>
                ...
                <div>
                    <div class="block rounded-lg shadow-lg bg-white">
                        <div class="overflow-hidden rounded-t-lg h-20" style="background-color: #7a81a8;">
                            <p class="text-white mt-3 text-2xl">Projects
                            </p>
                        </div>
            ...
            <div class="grid md:grid-cols-2 gap-6 text-center mt-5  ">
                <!-- line chart -->
                <div class="  shadow-lg rounded-lg h-3/5  ">
                    <div class="py-3 px-5 bg-gray-50">Line chart</div>
                    <canvas class="p-10" id="chartLine"></canvas>
                </div>
                <!-- doughnot chart -->
                <div class="shadow-lg rounded-lg overflow-hidden">
                    <div class="py-3 px-5 bg-gray-50">Users</div>
                    <canvas class="p-10" id="chartDoughnut"></canvas>
                </div>
            </div>
            <div class="block rounded-lg shadow-lg bg-white w-2/5 text-center" style="margin-top: -13rem; width:39rem;">
                        <div class="overflow-hidden rounded-t-lg h-20" style="background-color: orange;">
                            <p class="text-white mt-3 text-2xl">Requests</p>
                        </div>

                        <div class="p-6 font-mono text-gray-600">
                            <a href="request.php"><h4 class="text-2xl text-left font-semibold mb-2">Leave Requests</h4></a>
                            <a href="assetRequest.php"><h4 class="text-2xl text-left font-semibold mb-2">Asset Requests</h4></a>
...
<script>
    const dataDoughnut = {
        labels: ["Superadmin", "HR", "Employees"],
        datasets: [{
            label: "My First Dataset",
            data: [1, 1, 1],
            backgroundColor: [
