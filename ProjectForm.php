            ...
            <form class="w-full  my-5 bg-white p-2 " id="projectForm" name="createProject" action="leaveController.php" method="POST">
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <div class="relative">
                            <input type="text" name="manager" placeholder="project Manager" 
                                class="block appearance-none w-full bg-gray-50 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-state">
                ...
                <div class="flex flex-wrap -mx-3 mb-2">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <div class="relative">
                            ...
                            <input datepicker datepicker-orientation="bottom right" type="givenDate" id="startdate" name="startDate" autocomplete="off"
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <div class="relative">
                            <div class="relative">
                                ...
                                <input type="text" id="enddate" name="joined" autocomplete="off"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Select date">
                            </div>
                        </div>
