        ...
        <div class="w-full h-auto p-3  overflow-y-auto  bg-gray-100">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg my-4">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <?php $results = mysqli_query($db, "SELECT * FROM asset"); ?>
                    <tbody>
            ...
            <div class="flex space-x-2 justify-center">
                <button onclick="location.href='assetForm.php'" type="button"
                    class="inline-block  px-6 py-2.5 bg-orange-400 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-orange-500 hover:shadow-lg ">
