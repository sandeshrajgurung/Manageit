...
<body>
    ...
    <div class="flex">
        ...
        <div class="w-full h-auto p-3  overflow-y-auto  bg-gray-100">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo $roles['name'] ?></td>
                                        <?php if ($_SESSION['user']['roles_id'] == '3') {
            ...
            <?php if ($_SESSION['user']['roles_id'] !== '3') { ?>
            <button onclick="location.href='createProfile.php'"
