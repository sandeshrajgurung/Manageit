 ...
 <nav
    ...
    <div class="flex">
        ...
        <div class="w-full h-auto p-3  overflow-y-auto  bg-gray-100">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ml-1 text-sm font-medium text-gray-400 md:ml-2 dark:text-gray-500">Payroll</span>
                        </div>
                    </li>
                </ol>
            </nav>
                ...
                <div class="text-gray-700">
                    ...
                    <div class="grid md:grid-cols-2 text-sm">
                        <div class="grid grid-cols-2">
                            <div class="px-4 py-2 font-semibold">Employee Name</div>
                        ...
                        <div class="grid grid-cols-2">
                            <div class="px-4 py-2 font-semibold">Citizenship No.</div>
                            <div class="px-4 py-2">+977 9865327845</div>
                        </div>
                        <div class="grid grid-cols-2">
                            <div class="px-4 py-2 font-semibold">PFN number</div>
                            <div class="px-4 py-2">Kathmandu, Nepal</div>
                        </div>
                        <div class="grid grid-cols-2">
                            <div class="px-4 py-2 font-semibold">Pan Card</div>
                            <div class="px-4 py-2">Kathmandu, Nepal</div>
                        </div>
            ...
            <!-- Calculator -->
            <div class="bg-white grid md:grid-cols-2 gap-6 p-3 shadow-sm rounded-sm mt-4">
                <div>
                ...
                <div>
                    <label for="hours">Salary Per Hour:</label>
                    <input
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        type="text" id="hours" name="hours">
                </div>
                <div class="">
                    <label for="hours">Bonus:</label>
                    <input
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        type="text" id="hours" name="hours">
                </div>
                <div>
                    <label for="hours">Tax Rate:</label>
                    <input
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        type="text" id="hours" name="hours">
                </div>
            </div>
            <div class="bg-white grid md:grid-cols-2 gap-6 p-3 shadow-sm rounded-sm mt-1">
                <div class="">
                    <label class="text-green-700" for="hours">Total Income:</label>
                    <input
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        type="text" id="hours" name="hours">
                </div>
                <div>
                    <label class="text-red-500" for="hours">Total Deductions:</label>
                    <input
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        type="text" id="hours" name="hours">
                </div>
            ...
            <div class="flex space-x-2 justify-start">
                <button type="button"
                    class=" mt-3 inline-block px-6 py-2.5 bg-orange-400 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-orange-500 hover:shadow-lg ">Calculate</button>
            </div>
