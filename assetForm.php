            ...
            <form class="w-full  my-5 bg-white p-2 " id="leave_apply" name="leave_apply" action="leaveController.php" method="POST">
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <div class="relative">
                            <input type="text" name="employee" placeholder="Sandesh" disabled 
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <select name="assetType"
                                ...
                                <option value="Laptop-cooler">Laptop-cooler</option>
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Asset Details</label>
                        <textarea class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0
                                         focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="assetDetail" name="assetDetail"
