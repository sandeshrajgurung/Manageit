...
<nav
    ...
    <div class="flex">
        ...
        <div class="w-full h-auto p-3  overflow-y-auto  bg-gray-100">
                ...
                <div class="text-gray-700">
                    ...
                    <div class="grid md:grid-cols-2 text-sm">
                        ...
                        <div class="grid grid-cols-2">
                            ...
                            <div class="px-4 py-2"><?php echo $row['leave_from']; ?>-<?php echo $row['leave_to']; ?>
                            </div>
                        </div>
                        <div class="grid grid-cols-2">
            ...
            <form method="POST" action="leaveController.php">
            <input type="text" id="view" name="approval" value="1" hidden>
                <button type="submit" name="approve"
                class=" text-white font-bold py-2 px-4 my-4 rounded-full inline-flex items-center">
                    <i class="material-icons" style="color:green">thumb_up_alt</i>
                </button>
            </form>
            <form method="POST" action="leaveController.php">
            <input type="text" id="view" name="approval" value="0" hidden>
